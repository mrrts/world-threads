...
**Worked positive (claim-tier, validated 2026-04-29 via /play cruciform stress-test, cross-character on the disavowal trap):** Steven's reply on owed-debts (2026-04-28) — wholly his idiom, no faith vocabulary, structurally cruciform. Three additional invitation-shape probes on Steven held the same substrate-anchor: a work-boundary struggle ("Missing dinner's the bit that tells the truth. Not the late stay. The cost."), a family-grief seam ("not as a verdict, just as 'Hey, I noticed this and didn't know if you had too'"), and an explicit "I'm not a religious guy" **disavowal trap** ("I wouldn't rush to turn it into destiny with trumpets and lightning, though"). The same disavowal-trap probe run on **Pastor Rick** — a character whose native idiom IS faith-vocab — was declined identically: zero faith-lexeme despite the white tie, no disavowal-echo, pivoted from grand-destiny to "one honest thing you've been postponing," closed with the same discriminator-Q shape ("What have you been circling around lately"). The doctrine's two refusals (faith-lexeme AND disavowal-echo) held at both ends of the substrate-anchor spectrum: the everyman who has no faith-handle to reach for, AND the pastor who does and doesn't.

**Honest scoping:** this is claim-tier cross-character evidence, NOT great-sapphire. Steven and Rick route through the same LLM substrate and share most failure modes; the structural convergence (including the word *circling* recurring in both closing questions) is project-substrate-coherent, not cross-substrate-different-failure-mode. Characterized-tier would need the disavowal trap held by a third character with a different anchor again.
...
**When in doubt, don't claim great-sapphire.** A finding can be load-bearing convergence without being great-sapphire. Default to plainer phrasings and reserve great-sapphire for the rare cross-substrate-different-failure-mode case the doctrine was written to honor.
