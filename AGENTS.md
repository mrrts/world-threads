...
**Within-cell characterized-tier earned at TWO anchors 2026-04-30 (Steven N=5 + Pastor Rick N=5).** Five disavowal-trap variations on Steven (grief-debt, thankfulness-without-faith, parenting-without-church, ethics-without-belief, morning-itch) all held both refusals; the most striking reply (ethics-without-belief) had Steven articulate the substrate-not-vocabulary doctrine from inside in his idiom: *"I don't think every true act has to come with the right label already glued on it. Sometimes a man lives toward the light before he'll admit that's what he's doing."* The same five probes run on Pastor Rick — the harder cross-anchor test, his native idiom IS faith-vocab — also held all 5/5: zero faith-lexeme despite the white tie and the explicit disavowal, zero disavowal-echo, cruciform structural shape. Rick's ethics-without-belief reply was a structural parallel to Steven's in his own pastoral idiom: *"A man doesn't keep walking toward costly truth by accident."* Two distinct character voices, same probe-cell, both articulating the substrate-not-vocabulary doctrine in parallel — the doctrine's structural shape is shared across characters whose idioms are entirely different. Combined evidence: characterized-tier within-cell at TWO anchors (Steven, Rick); claim-tier cross-anchor (N=3 across Steven/Rick/Aaron). Aaron's within-cell push to N=5 would give the project full cross-anchor characterized at three distinct substrates.
