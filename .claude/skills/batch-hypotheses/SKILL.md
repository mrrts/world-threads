...
synthesis but don't outsource the verdict. Per CLAUDE.md trust-the-eye: read
...
<numbered list per CLAUDE.md open-thread-hygiene doctrine>
```
...
- **Outsourced verdict drift.** The convenience of having ChatGPT write the
  ...
  yourself. Per CLAUDE.md trust-the-eye: read at least 2-3 individual replies
...
- **Tier inflation.** Per-hypothesis N=1 inside the bundled call is sketch-tier
  per CLAUDE.md evidentiary doctrine. Don't write claim-tier or characterized-
