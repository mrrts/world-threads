...
MODE0_BIN="${WORLDTHREADS_DECODED_MODE0_BIN:-$HOME/.worldcli/decoded-register/worldcli-mode0}"
MODE1_BIN="${WORLDTHREADS_DECODED_MODE1_BIN:-$HOME/.worldcli/decoded-register/worldcli-mode1}"
